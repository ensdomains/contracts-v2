...
This branch has a standalone HCA, owner-only wallet-paid batches, an owner-bound deployer, and local tests. Manager still uses the legacy HCA. Production security, funding, routing, and app integration remain incomplete.
