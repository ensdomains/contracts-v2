...
abstract contract EnhancedAccessControl is HCAContext, ERC165, IEnhancedAccessControl {
    ...
    /// @inheritdoc IEnhancedAccessControl
    function hasRoles(uint256 resource, uint256 roleBitmap, address account) public view virtual returns (bool) {
    ...
    function _transferRoles(uint256 resource, address srcAccount, address dstAccount, bool executeCallbacks)
        internal
        virtual
    {
    ...
    function _revokeRoles(uint256 resource, uint256 roleBitmap, address account, bool executeCallbacks)
        internal
        virtual
        returns (bool)
    {
    ...
    function _getSettableRoles(uint256 resource, address account) internal view virtual returns (uint256) {
        uint256 adminRoleBitmap =
            (_roles[resource][account] | _roles[ROOT_RESOURCE][account]) & EACBaseRolesLib.ADMIN_ROLES;
