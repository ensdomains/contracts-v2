...
contract L2ReverseRegistrarTest is Test {
    ...
    function test_setName_invalidatesPriorUnusedSignature() public {
        ...
        IL2ReverseRegistrar.NameClaim memory claim =
            IL2ReverseRegistrar.NameClaim({name: signedName, addr: user1, chainIds: chainIds, signedAt: signedAt});
    ...
    function test_setNameForAddr_invalidatesPriorUnusedOwnableSignature() public {
        ...
        IL2ReverseRegistrar.NameClaim memory claim =
            IL2ReverseRegistrar.NameClaim({name: signedName, addr: address(mockOwnableEoa), chainIds: chainIds, signedAt: signedAt});
    ...
    function test_setNameForAddrWithSignature_allowsScaSignaturesERC1271() public {
        ...
        IL2ReverseRegistrar.NameClaim memory claim =
            IL2ReverseRegistrar.NameClaim({name: name_, addr: address(mockSca), chainIds: chainIds, signedAt: signedAt});
    ...
    function test_setNameForAddrWithSignature_allowsUndeployedScaSignaturesERC6492() public {
        ...
        uint256[] memory chainIds = _singleChainIdArray();
        IL2ReverseRegistrar.NameClaim memory claim =
            IL2ReverseRegistrar.NameClaim({name: name_, addr: predictedAddress, chainIds: chainIds, signedAt: signedAt});
    ...
    function test_setNameForAddrWithSignature_revert_signedAtNotAfterInception() public {
        ...
        // First, set a name to establish an inception
        {
            ...
            IL2ReverseRegistrar.NameClaim memory claim =
                IL2ReverseRegistrar.NameClaim({name: "myname.eth", addr: user1, chainIds: chainIds, signedAt: signedAt});
        ...
        // Now try to use a signature with signedAt equal to the inception (should fail)
        {
            ...
            IL2ReverseRegistrar.NameClaim memory claim =
                IL2ReverseRegistrar.NameClaim({name: "newname.eth", addr: user1, chainIds: chainIds, signedAt: signedAt});
    ...
    function test_setNameForAddrWithSignature_allowsNewerSignature() public {
        ...
        // First signature
        {
            ...
            IL2ReverseRegistrar.NameClaim memory claim =
                IL2ReverseRegistrar.NameClaim({name: "first.eth", addr: user1, chainIds: chainIds, signedAt: signedAt1});
...

        {
            ...
            IL2ReverseRegistrar.NameClaim memory claim =
                IL2ReverseRegistrar.NameClaim({name: "second.eth", addr: user1, chainIds: chainIds, signedAt: signedAt2});
    ...
    function test_setNameForContractWithSignature_allowsEoaOwner() public {
        ...
        bytes32 message =
            _createNameForOwnableMessage(name_, address(mockOwnableEoa), user1, chainIds, signedAt);
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(user1Pk, message);
        bytes memory signature = abi.encodePacked(r, s, v);
    ...
    function test_setNameForContractWithSignature_revert_ownerAddressNotOwnerOfContract() public {
        ...
        bytes32 message =
            _createNameForOwnableMessage(name_, address(mockOwnableEoa), user2, chainIds, signedAt);
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(user2Pk, message);
        bytes memory signature = abi.encodePacked(r, s, v);
    ...
    function test_setNameForContractWithSignature_revert_targetDoesNotImplementOwnable() public {
        ...
        bytes32 message =
            _createNameForOwnableMessage(name_, address(registrar), user1, chainIds, signedAt);
        (uint8 v, bytes32 r, bytes32 s) = vm.sign(user1Pk, message);
        bytes memory signature = abi.encodePacked(r, s, v);
    ...
    function test_setNameForContractWithSignature_revert_signedAtNotAfterInception() public {
        ...
        // Now try to use a signature with signedAt equal to the inception (should fail)
        {
            ...
            IL2ReverseRegistrar.NameClaim memory claim =
                IL2ReverseRegistrar.NameClaim({name: "newname.eth", addr: address(mockOwnableEoa), chainIds: chainIds, signedAt: signedAt});
