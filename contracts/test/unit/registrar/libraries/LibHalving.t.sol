...
contract LibHalvingTest is Test {
    ...
    function test_halving_computed() external pure {
        ...
        _assertNear(LibHalving.halving(7645843420289247, 2217, 5130), 1537665107975056, 1537661454800508, 6);
        _assertNear(LibHalving.halving(41496322237742742, 9631, 138777), 1906996964267, 1906978706870, 6);
        _assertNear(LibHalving.halving(324922745063857570, 3699, 14160), 22878240879739585, 22878035801573052, 6);
        _assertNear(LibHalving.halving(7160344361217578864, 376, 2562), 63645461810911484, 63645361554348369, 6);
        _assertNear(LibHalving.halving(48224578080290028571, 4891, 37054), 252744870505318051, 252742620367330313, 6);
        _assertNear(LibHalving.halving(105105524861191541746, 6259, 54700), 245923975222518136, 245923149907088301, 6);
        _assertNear(
            LibHalving.halving(3099396934116196421933, 3511, 31839), 5773426072293995295, 5773376140217802275, 6
        );
        _assertNear(
            LibHalving.halving(26362372193702182792471, 4465, 32623), 166549977597448035667, 166549775208987485845, 6
        );
        _assertNear(
            LibHalving.halving(990909067413969805326317, 301, 3338), 454678187455967549808, 454675088014747167270, 6
        );
        _assertNear(
            LibHalving.halving(3381740391629922203681908, 715, 10038), 200878650042027568241, 200877705112613028527, 6
        );
        _assertNear(
